...
HELP_STRING = f"★ 𝗘𝗣𝗦𝗧𝗘𝗜𝗡 𝗛𝗘𝗟𝗣 𝗠𝗘𝗡𝗨 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @EPSTEIN_ISLAND_OWNER**"
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own Altron Bots !! @EPSTEIN_ISLAND_OWNER", cache_time=0, alert=True)
